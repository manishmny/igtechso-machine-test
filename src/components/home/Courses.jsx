...
const Courses = () => {
  return (
    <>
      <div className="container padding-equal" id="course">
        <div className="course-d default-85">
          <div className="heading-d text-center mb-5">
            <span className="title">Quality features</span>
            <h2 className="sub-heading">Popular Designing Course</h2>
          </div>
                    ...
                    <div className="d-flex gap-4 align-items-center justify-content-between">
                      <div className="d-flex gap-4 align-items-center justify-content-start">
                        <span>
                          ...
                          >
                            ...
                            />
                            <path
                              d="M35.1131 61C34.2352 61 33.5234 60.2882 33.5234 59.4102V31.5897C33.5234 30.7117 34.2352 30 35.1131 30L60.9465 44.3076C60.9465 44.3076 62.1388 45.4999 60.9465 46.6923C59.7542 47.8846 35.1131 61 35.1131 61Z"
                              fill="#EF9E48"
                            />
                          </svg>
                        </span>
                        <div>
                          <div className="star-d d-flex align-items-center gap-2 mb-1">
                            <span>
                              <svg
                                width="109"
                                height="40"
                        ...
                        <div className="small-text"> */}
                            <h6 className="m-0">
                              ...
                              {tutorial.students} students watched
                            </h6>
                          </div>
                      ...
                      <div>
                        <button className="default-btn secondary-btn">
                          7 Video Courses | 4hrs
                        </button>
                      </div>
                    </div>
                    <div className="expend-d">
                      <span>
                        <svg
                          width="22"
                          height="22"
